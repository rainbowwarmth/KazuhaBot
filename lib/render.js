...
import { writeFileSyncEx } from '../lib/common.js';
import { _path, botStatus } from '../lib/global.js';
...
const html = {};
var lock = false;
export async function render(renderData) {
...
export async function renderURL(renderData) {
