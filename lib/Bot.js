...
async function initGlobals() {
    ...
    const taskList = [
        mysNew_1.ystaskPushNews,
        mysNew_1.bbbtaskPushNews,
        mysNew_1.bbtaskPushNews,
        mysNew_1.zzztaskPushNews,
        mysNew_1.srtaskPushNews,
        mysNew_1.wdtaskPushNews,
        mysNew_1.dbytaskPushNews
    ];
